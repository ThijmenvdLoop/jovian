...
| root*/results              | [Bacteria\|Phage\|Taxonomic\|Virus]_rank_statistics.tsv | Tab separated flatfile (US-ASCII)   | No. of unique taxonomic assignments from top-level taxonomy to species for Bacterial, Phage and Virus assigned scaffolds            |
...
| root*/results              | Superkingdoms_quantities_per_sample.csv                 | Comma separated flatfile (US-ASCII) | Intermediate top-level taxonomy file for the profile_read files listed above. The filename is kept for compatibility.               |
...
| root*/results/heatmaps     | [Bacteria\|Phage\|Superkingdom\|Virus]_heatmap.html     | HTML file (US-ASCII)                | Heatmaps for different taxonomic strata down to species level assignment. Superkingdom filenames are legacy compatibility labels.   |
